...
from model.mobilenet.model_config import MODEL_SPECS
...
class MobileNetV4C(nn.Module):
    def __init__(self, model="MNV4ConvSmall-Custom"):
        super().__init__()
        assert model in MODEL_SPECS.keys()
        self.model = model
        self.spec = MODEL_SPECS[self.model]
...
if __name__ == "__main__":
    ...
    net = MobileNetV4C("MNV4ConvSmall-Custom")
    x = torch.randn(1,4,416,416)
